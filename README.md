...
MovieMate is a React-based movie website that allows users to search for movies by title, sort them by genre, view trending and upcoming movies, and bookmark their favorite movies. The website is designed to be user-friendly and visually appealing.
<hr/>
...
MovieMate is built using the following technologies:
...
Follow these steps to obtain the required keys and configuration:
...
Contributions are always welcome, open a **Pull Request** and help us improve MovieMate.
