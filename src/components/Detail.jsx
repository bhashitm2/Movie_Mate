    ...
    <>
      {loader ? (
        ...
        <>
          ...
          <div className="text-red-100 font-semibold my-3 flex justify-center">
            <h2 className="bg-red-600/30 border-2 border-red-700 py-2 px-3 rounded-full">
          ...
          <div className="flex flex-col items-center">
            <h1 className="text-3xl text-red-300 font-semibold text-center p-2">
              Cast
            </h1>
                  ...
                  {cast.profile_path !== null ? (
                    <>
                      <div className="flex min-w-[9rem] md:min-w-[10rem] max-w-[9rem] md:max-w-[10rem] h-full items-center text-center flex-col mx-1">
                        ...
                        <p className="text-red-300">({cast.character})</p>
                      </div>
                    </>
                  ) : null}
                </>
